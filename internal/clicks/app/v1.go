...
func (a *App) configureAppV1(ctx context.Context) (*ConfigureAppResponse, error) {
	...
	tilesStorage := redis_tile_storage.New(a.redisClient, a.config.TilesStorage.SetAndPublishSha1)
